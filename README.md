...
| Online Accounts | Separate daily Website, Android App, iOS App, and Cash sales; Normal/Long digital passenger counts; editable cash-expense categories; clustered and day-by-day final reporting; Print, PDF, Share, and Excel-compatible exports. Access is controlled by role permissions, with built-in access for Super Admin, Admin, and Online Manager. |
